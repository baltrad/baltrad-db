...
class Oh5NodeBackend {
  public:
    ...
    Oh5NodeBackend* clone() const { return do_clone(); }
 
  protected:
    Oh5NodeBackend() { }
    Oh5NodeBackend(const Oh5NodeBackend& other);

  private:
    Oh5NodeBackend& operator=(const Oh5NodeBackend& rhs);
    ...
    virtual Oh5NodeBackend* do_clone() const = 0;
};
