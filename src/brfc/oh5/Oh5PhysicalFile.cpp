...
Oh5PhysicalFile::Oh5PhysicalFile()
        : metadata_()
        , path_() {
}

Oh5PhysicalFile::Oh5PhysicalFile(const std::string& path)
        : metadata_()
        , path_(path) {
    Oh5HlFileReader().read(path, *this);
}

Oh5PhysicalFile::Oh5PhysicalFile(const std::string& object,
                 const Date& date,
                 const Time& time,
