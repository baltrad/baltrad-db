...
TEST(oh5_Oh5Source_test, test_from_string_empty) {
    Oh5Source s = Oh5Source::from_string("");
    EXPECT_EQ((size_t)0, s.keys().size());
}

TEST(oh5_Oh5Source_test, test_from_string_skip_empty) {
    Oh5Source s = Oh5Source::from_string("WMO:");
...
TEST(oh5_Oh5Source_test, test_at) {
    Oh5Source s;
...
TEST(oh5_Oh5Source_test, test_keys) {
    Oh5Source s;
...
TEST(oh5_Oh5Source_test, test_all_keys) {
    Oh5Source s;
...
TEST(oh5_Oh5Source_test, test_remove) {
    Oh5Source s;
...
TEST(oh5_Oh5Source_test, test_to_string) {
    Oh5Source s;
