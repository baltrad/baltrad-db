...
public class OperatorSubTest {
  OperatorSub classUnderTest;

  @Before
  public void setUp() {
    classUnderTest = new OperatorSub();
  }
  ...
  public void executeBinary_Long_Long() {
    ...
    assertEquals(Long.valueOf(-1), result.toLong());
  }

  @Test
  public void executeBinary_Double_Double() {
    Expression lhs = new DoubleExpression(3.0);
    Expression rhs = new DoubleExpression(1.0);

    Expression result = classUnderTest.executeBinary(lhs, rhs);
    assertTrue(result.isDouble());
    assertEquals(Double.valueOf(2.0), result.toDouble());
  }
  ...
  public void executeBinary_Long_Double() {
    ...
    Expression result = classUnderTest.executeBinary(lhs, rhs);
    assertTrue(result.isDouble());
    assertEquals(Double.valueOf(-0.8), result.toDouble());
  }
