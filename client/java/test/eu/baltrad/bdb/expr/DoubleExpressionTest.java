...
public class DoubleExpressionTest {
  private DoubleExpression classUnderTest;

  @Before
  public void setUp() {
    classUnderTest = new DoubleExpression(1);
  }
  ...
  public void equals_sameValue() {
    assertTrue(classUnderTest.equals(new DoubleExpression(1)));
  }

  @Test
  public void equals_differentValue() {
    assertFalse(classUnderTest.equals(new DoubleExpression(2)));
  }

  @Test
  public void hashCode_sameValue() {
    DoubleExpression other = new DoubleExpression(1);
